...
## Mean Phylogenetic Distance Between Communities (COMDIST)
...
O método de ponderação difusa calcula uma matriz P que descreve a abundância das espécies ponderada pela filogenia, o que equivale a descrever 
...
## Relacionando matrizes pareadas de PBD com variáveis ambientais
